...
{
	// 정점 및 픽셀 쉐이더를 초기화합니다.
	return InitializeShader(device, hwnd, L"../DXEngine/Color.vs", L"../DXEngine/Color.ps");
}
...
bool ColorShaderClass::InitializeShader(ID3D11Device* device, HWND hwnd, WCHAR* vsFilename, WCHAR* psFilename)
{
	...
	// 이 설정은 ModelClass와 쉐이더의 VertexType 구조와 일치해야합니다.
	...
	// 정ㅈ머 쉐이더에 있는 행렬 상수 버퍼의 구조체를 작성합니다.
